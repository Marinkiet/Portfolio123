...
export const metadata: Metadata = {
  title: "Marinkie Thupi - CodePencil"
}
    ...
    <section className="h-screen">
      <section className="px-1 py-8 flex justify-start  sm:justify-between gap-8">
        ...
        <div className="align-middle justify-center">
          <ProjectButton nextStyle="hover:bg-green-100 rounded-lg hover:shadow-md" projectLink="jobapp" projectName="Next -> Job Search App " projectYear="2024" githubLink="" />
